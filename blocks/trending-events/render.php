<?php
/**
 * Server-side render for the `evently/trending-events` block — delegates entirely to
 * the same template-part the built-in demo homepage uses
 * (template-parts/home/trending-events.php), so editing Evently → Theme Settings
