<?php
	/**
	 * Evently override of mage-eventpress Default Theme.
	 *
	 * Copied from templates/themes/default-theme.php so Event Timelines
	 * render after Frequently Asked Questions (plugin order is timeline → FAQ).
	 *
	 * @package Evently
	 */
